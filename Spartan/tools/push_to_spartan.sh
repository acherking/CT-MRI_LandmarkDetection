...
res_path=/Users/achs/PhD/code/CT-MRI_LandmarkDetection/Spartan/res
...
rsync -tv -e ssh ${res_path}/*.npy wezw@spartan.hpc.unimelb.edu.au:/data/gpfs/projects/punim1836/Training/res
